...
#   def active(self):
#       """Returns if member is still active in any section. Red members doesn't count."""
#
#       try:
#           MemberGroupLink.objects.filter(member__id=self.id).exclude(date_end__lt=datetime.today()).exclude(group__id=16)
#       except:
#           return u'---'
