...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MemberGroupLink.card_number'
        db.add_column(u'members_membergrouplink', 'card_number',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MemberGroupLink.card_number'
        db.delete_column(u'members_membergrouplink', 'card_number')
    ...
    models = {
        ...
        u'members.membergrouplink': {
            ...
            'card_number': ('django.db.models.fields.CharField', [], {'max_length': '10', 'null': 'True', 'blank': 'True'}),
