...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'members_member', 'join_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Member.leave_date'
        db.add_column(u'members_member', 'leave_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Member.oib'
        db.add_column(u'members_member', 'oib',
                      self.gf('django.db.models.fields.CharField')(max_length=11, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Member.college'
        db.add_column(u'members_member', 'college',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Member.college_confirmation'
        db.add_column(u'members_member', 'college_confirmation',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'members_member', 'join_date')

        # Deleting field 'Member.leave_date'
        db.delete_column(u'members_member', 'leave_date')

        # Deleting field 'Member.oib'
        db.delete_column(u'members_member', 'oib')

        # Deleting field 'Member.college'
        db.delete_column(u'members_member', 'college')

        # Deleting field 'Member.college_confirmation'
        db.delete_column(u'members_member', 'college_confirmation')
    ...
    models = {
        ...
        u'members.member': {
            ...
            'membership_payed': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
