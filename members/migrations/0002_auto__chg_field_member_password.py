...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'members_member', 'password', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'Member.password'
        db.alter_column(u'members_member', 'password', self.gf('django.db.models.fields.CharField')(max_length=32, null=True))
