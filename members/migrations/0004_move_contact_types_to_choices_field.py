    ...
    def forwards(self, orm):
        ...
        for contact in contacts:
            if contact.contact_type_id == 1:
                contact.contact_type_char = 'cell'
            elif contact.contact_type_id == 2:
                contact.contact_type_char = 'email'
            elif contact.contact_type_id == 3:
                contact.contact_type_char = 'phone'

            contact.save()

    def backwards(self, orm):
        raise RuntimeError('Cannot to backwards migration here.')
